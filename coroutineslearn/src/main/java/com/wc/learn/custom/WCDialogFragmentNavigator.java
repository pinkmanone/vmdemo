...
public final class WCDialogFragmentNavigator extends Navigator<WCDialogFragmentNavigator.Destination> {
    ...
    public WCDialogFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager) {
        mContext = context;
    ...
    /**
     * NavDestination specific to {@link WCDialogFragmentNavigator}.
     */
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(WCDialogFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link WCDialogFragmentNavigator} which this destination
