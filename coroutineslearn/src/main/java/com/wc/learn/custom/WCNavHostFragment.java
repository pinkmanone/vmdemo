 ...
 */
public class WCNavHostFragment extends Fragment implements NavHost {
     ...
     * looking first for a {@link WCNavHostFragment} along the given Fragment's parent chain.
    ...
    public static NavController findNavController(@NonNull Fragment fragment) {
        ...
        while (findFragment != null) {
            if (findFragment instanceof WCNavHostFragment) {
                return ((WCNavHostFragment) findFragment).getNavController();
            }
            Fragment primaryNavFragment = findFragment.getParentFragmentManager()
                    .getPrimaryNavigationFragment();
            if (primaryNavFragment instanceof WCNavHostFragment) {
                return ((WCNavHostFragment) primaryNavFragment).getNavController();
            }
     ...
     */
    @NonNull
    public static WCNavHostFragment create(@NavigationRes int graphResId) {
    ...
    public static WCNavHostFragment create(@NavigationRes int graphResId,
        ...
        final WCNavHostFragment result = new WCNavHostFragment();
        if (b != null) {
     ...
     * <p>
     * By default, this adds a {@link WCFragmentNavigator}.
     * <p>
    ...
    protected void onCreateNavController(@NonNull NavController navController) {
        navController.getNavigatorProvider().addNavigator(
                new WCDialogFragmentNavigator(requireContext(), getChildFragmentManager()));
    ...
    public void onAttachFragment(@NonNull Fragment childFragment) {
        ...
        WCDialogFragmentNavigator dialogFragmentNavigator =
                mNavController.getNavigatorProvider().getNavigator(WCDialogFragmentNavigator.class);
     ...
     * {@link WCFragmentNavigator}, which replaces the entire contents of the NavHostFragment.
     * <p>
     * This is only called once in {@link #onCreate(Bundle)} and should not be called directly by
     * subclasses.
    ...
    @Deprecated
    @NonNull
    protected Navigator<? extends WCFragmentNavigator.Destination> createFragmentNavigator() {
        return new WCFragmentNavigator(requireContext(), getChildFragmentManager(),
                getContainerId());
    }
