...
public class WCFragmentNavigator extends Navigator<WCFragmentNavigator.Destination> {
    ...
    public WCFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                               int containerId) {
        mContext = context;
...
//        ft.replace(mContainerId, frag);
    ...
    /**
     * NavDestination specific to {@link WCFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(WCFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link WCFragmentNavigator} which this destination
